...
# declarative_base is used to turn our classes into database models
...
addUser("Johnny","Cochran",123,7)
addUser("Billy Bob","Thornton",62,5)
addUser("Joey","Boosnater",23,9)
addUser("Emfil","Keesh",673,1)
